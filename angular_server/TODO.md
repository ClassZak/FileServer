...
- [ ] **Modal overlay click**: Enable closing modals by clicking on the backdrop for better UX.
...
- [ ] **Move tokens to httpOnly cookies**: Replace `localStorage` with secure cookies to mitigate XSS risks.
